...
func TestBinanceArchitectureLayerAssignments(t *testing.T) {
	...
	layers := []struct {
		...
		{"L2/Routing", []layerPrefix{{value: "github.com/coachpo/meltica/exchanges/binance/routing"}, {value: "github.com/coachpo/meltica/exchanges/binance/internal"}, {value: "github.com/coachpo/meltica/market_data/framework/router"}}},
