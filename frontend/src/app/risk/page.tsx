...
export default function RiskPage() {
  ...
  useEffect(() => {
    ...
    setPresence(computeRiskPresence(riskQuery.data.limits as Partial<RiskConfig>));
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const resolvedPresence = computeRiskPresence(response.limits as Partial<RiskConfig>);
      setLimits(normalized);
      setEditMode(false);
