...
// Config holds the generic configuration required to construct an exchange instance.
type Config struct {
	APIKey    string
	APISecret string
...
// ExchangeFactory builds a concrete exchange instance.
...
// Resolve constructs an exchange for the given name, applying any options.
