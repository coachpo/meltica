...
func (w *WS) orderEventFromTrade(id string, rec map[string]any) *coreprovider.OrderEvent {
...
func (w *WS) orderEventFromOpenOrder(id string, rec map[string]any) *coreprovider.OrderEvent {
