...
func NewBaseLambda(id string, config Config, bus databus.Bus, control controlbus.Bus, orderSubmitter OrderSubmitter, pools *pool.PoolManager, strategy TradingStrategy) *BaseLambda {
	if id == "" {
